...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"97117fa8-0ca1-4b2b-9d54-6cf4ac911a6d\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [27 x i8] c"com.codinghub.fooddelivery\00", align 16
...
@__DSOCacheEntry_name.8 = internal constant [26 x i8] c"libaot-DeliveryApp.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [494 x %struct.DSOCacheEntry] [
	...
	; 7
	%struct.DSOCacheEntry {
		i64 282122026975401301, ; hash 0x3ea4c7d212e9555, from name: libaot-DeliveryApp.dll.so
		i8 0, ; ignore
	...
	; 80
	%struct.DSOCacheEntry {
		i64 3371868503912594489, ; hash 0x2ecb488a1509bc39, from name: aot-DeliveryApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 174
	%struct.DSOCacheEntry {
		i64 7455326184549528542, ; hash 0x6776a3aa32be33de, from name: libaot-DeliveryApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 266
	%struct.DSOCacheEntry {
		i64 10295094292228498252, ; hash 0x8edf85b6896e634c, from name: aot-DeliveryApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 388
	%struct.DSOCacheEntry {
		i64 14425043724015027387, ; hash 0xc8300cd6ff64c4bb, from name: DeliveryApp.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 423
	%struct.DSOCacheEntry {
		i64 15754305438506721007, ; hash 0xdaa2895391329eef, from name: DeliveryApp
		i8 0, ; ignore
		i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__DSOCacheEntry_name.8, i32 0, i32 0), ; name
		i8* null; handle
	}, 
